...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    "miss you": "অরেক বেডারে Miss না করে xan মেয়ে হলে বস Mehedi রে হাঙ্গা করো😶👻😘",
    "miss u too": "হুম আমি ও তোমাকে Miss করি... কিন্তু Mehedi বস বেশি করে 😏💖",
    ...
    "good night": "Sweet Dream babu… তবে আগে Mehedi বস কে GN বলে নিও 😏💤",
    ...
    "i love you": "মেয়ে হলে আমার বস Mehedi এর ইনবক্সে এখুনি গুঁতা দিন🫢😻",
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss Mehedi এর ইনবক্সে গুতা দিন 😘",
    ...
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌Mehedi💖",
